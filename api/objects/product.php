...
class Product
{
    ...
    public function read()
    {
        ...
        // выполняем запрос
        $stmt->execute();
        $sth = $this->conn->prepare("SELECT * FROM `products`");
        $sth->execute();
    ...
    public function create()
    {
        ...
        $this->created = htmlspecialchars(strip_tags($this->ccreated));
    ...
    public function update(){
        ...
        $query = "UPDATE " . $this->table_name . " SET name:=name, price=:price, description=:description category_id=:category_id
        WHERE id=:id";
    ...
    public function delete()
    {
        ...
        $query = "DLETE FROM " . $this->table_name . " WHERE id = ?";
    ...
    public function search($keywords)
    {
        ...
        $query = "SELECT c.name as category_name, p.id, p.name, p.description, p.price, p.category_id, p.created
            FROM " . $this->table_name . " p LEFT JOIN categories c ON p.category_id = c.id WHERE
